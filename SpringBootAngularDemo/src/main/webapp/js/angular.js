...
app.controller('getallcustomersController', function($scope, $http, $location) {
	...
	$scope.getAllCustomers = function() {
		var url = $location.absUrl() + "customerdetails";
...
app.controller('getcustomerbyfirstnameController', function($scope, $http,
		$location) {

	$scope.showCustomersByFirstName = false;

	$scope.getCustomerByFirstName = function() {

		var url = $location.absUrl() + "findbyfirstname";
		...
		$http.get(url, config).then(function(response) {
			...
			if (response.data.status == "Done") {
				$scope.allcustomersbyfirstname = response.data;
				$scope.showCustomersByFirstName = true;
