...
<body>
	<div class="container" ng-app="app">
		...
		<div class="row">
				...
				<div ng-show="showCustomersByLastName">
					...
					<ul class="list-group">
						<li ng-repeat="customer in allcustomersbylastname.data"><h4
								class="list-group-item">
								<strong>Customer {{$index}}</strong><br /> Id: {{customer.id}}<br />
								First Name: {{customer.firstName}}<br /> Last
			...
			<div ng-controller="getcustomerbyfirstnameController"
				class="col-md-4">
				<h3>Customer by firstName</h3>
				<input type="text" class="form-control" style="width: 100px;"
					ng-model="customerFirstName" /><br />
				<button ng-click="getCustomerByFirstName()">Get Customers
					By First Name</button>
				<div ng-show="showCustomersByFirstName">
					<ul class="list-group">
						<li ng-repeat="customer in allcustomersbyfirstname.data">
